...
import bookbird.bookbird.Model.Request;
import bookbird.bookbird.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//PayU init
		Payu.setInstance(this); //sets initial context for payu
	...
	private void showAlertDialog() {
		...
		alertDialog.setView(edtAddress);  //Adds edit text to alert dialog
	...
	public void navigateToBaseActivity(View view) {
		...
		merchantKey = "gtKFFx";
		String amount = txtTotalPrice.getText().toString();
		String email = Common.CurrentUser.getPhone();
